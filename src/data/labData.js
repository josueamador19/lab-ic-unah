...
export const SERVICIOS = {
  suelos: {
    ...
    norma: 'ASTM / AASHTO',
    items: [
      { code: 'SU-01', name: 'Contenido de Humedad',   norma: 'ASTM D2216',               precio: 2 },
      { code: 'SU-02', name: 'Granulometría',          norma: 'ASTM D6913 / AASHTO T88',  precio: 10 },
      { code: 'SU-04', name: 'Límite Líquido',         norma: 'ASTM D4318 / AASHTO T89',  precio: 0 },
      { code: 'SU-05', name: 'Límite Plástico',        norma: 'ASTM D4318 / AASHTO T90',  precio: 0 },
      { code: 'SU-09', name: 'Clasificación de Suelo', norma: 'ASTM D2487 / AASHTO M145', precio: 0 },
      { code: 'SU-10', name: 'Proctor Estándar',       norma: 'ASTM D698 / AASHTO T99',   precio: 0 },
      { code: 'SU-11', name: 'Proctor Modificado',     norma: 'ASTM D1557 / AASHTO T180', precio: 0 },
      { code: 'SU-19', name: 'Peso Específico',        norma: 'ASTM D854 / AASHTO T100',  precio: 0 },
      { code: 'SU-21', name: 'Peso Volumétrico',       norma: 'ASTM D7263',               precio: 0 },
      { code: 'SU-22', name: 'Hidrometría',            norma: 'ASTM D7928 / AASHTO T88',  precio: 0 },
    ],
  },
  concreto: {
    ...
    norma: 'ASTM',
    items: [
      { code: 'CU-01', name: 'Curado de Cilindros',           norma: 'ASTM C31 / AASHTO T23', precio: 0 },
      { code: 'CU-04', name: 'Rotura de Cilindros y bloques', norma: 'ASTM C39 / AASHTO T22', precio: 0 },
    ],
  },
  agregados: {
    ...
    norma: 'ASTM',
    items: [
      { code: 'AG-02', name: 'Desgaste Los Ángeles',      norma: 'ASTM C131 / AASHTO T96',  precio: 50 },
      { code: 'AG-04', name: 'Peso Unitario con Golpes',  norma: 'ASTM C29 / AASHTO T19',   precio: 20 },
      { code: 'AG-05', name: 'Peso Unitario sin Golpes',  norma: 'ASTM C29 / AASHTO T19',   precio: 0 },
      { code: 'AG-08', name: 'Alterabilidad por Sulfatos',norma: 'ASTM C88 / AASHTO T104',  precio: 0 },
    ],
  },
  acero: {
    ...
    norma: 'ASTM A615',
    items: [
      { code: 'AC-01', name: 'Varillas a Tensión — Fluencia y Elongación', sub: 'No. 11, 10 y 8', norma: 'ASTM A615 / ASTM E8', precio: 0 },
      { code: 'AC-02', name: 'Varillas a Tensión — Fluencia y Elongación', sub: 'No. 6 y 8',      norma: 'ASTM A615 / ASTM E8', precio: 0 },
      { code: 'AC-03', name: 'Varillas a Tensión — Fluencia y Elongación', sub: 'No. 4 y 3',      norma: 'ASTM A615 / ASTM E8', precio: 0 },
    ],
  },
}
...
export const TOPOGRAFIA = {
  catastral: {
    ...
    pill: 'ST-01 — ST-03',
    items: [
      { code: 'ST-01', name: 'Tegucigalpa (TGU)',         note: 'Tarifa por día de trabajo en campo',      norma: 'Normas Propias', precio: 0 },
      { code: 'ST-02', name: 'San Pedro Sula (SPS)',       note: 'Tarifa por día de trabajo en campo',      norma: 'Normas Propias', precio: 0 },
      { code: 'ST-03', name: 'Tierra Adentro / Interior', note: 'Incluye viáticos según zona de destino',  norma: 'Normas Propias', precio: 0 },
    ],
  },
  ingenieria: {
